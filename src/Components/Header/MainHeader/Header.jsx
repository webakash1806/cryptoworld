...
const Header = () => {
    ...
    return (
        <header className='flex w-full md:justify-between  md:pl-14 md:pr-6 lg:pl-16 lg:pr-8 lg:p-2 bg-[#8247E5] text-white items-center justify-around z-[100] pt-[6px] pb-[6px] shadow-[-1px_1px_7px_#000] fixed top-0 left-0'>
            ...
            ${barActive ? "top-[2.95rem] left-[-55rem] duration-[0.5s]" : "top-[2.85rem] left-0 duration-[0.5s]"}
