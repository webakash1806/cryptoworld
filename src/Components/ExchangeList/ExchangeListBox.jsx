...
const ExchangeListBox = ({ id, image, name, rank, }) => {
    return (
        <>
            <div key={id} className="flex items-center justify-left border-b-[1px] border-[#b5b5b580] dark:border-[#6f6f6fab] pt-2.5 pb-2.5 h-[3.5rem] cursor-pointer hover:bg-[#06a0ff0a]">
                <Link to={`/cryptoworld/exchange/${id}`} className="flex items-center justify-left ">
