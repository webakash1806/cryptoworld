    ...
    return (
        <>
            <div className='text-[15px] md:text-[15px] lg:text-[16px] flex lg:gap-3 items-center justify-left border-b-[1px] border-[#b5b5b580] dark:border-[#6f6f6fab] pt-2.5 pb-2.5 h-[3.5rem] w-fit'>
                ...
                <p className='min-w-[5rem]  md:min-w-[5.5rem] flex items-center justify-center pr-3'>{score === "green" ? <span className='h-3 w-3 bg-green rounded-[50%]'></span> : <span className='h-3 w-3 bg-red rounded-[50%]'></span>}</p>
            </div>
        </>
